...
export default function Contact() {
  ...
  <p className="mt-5">
      ...
      <ul>
        <li><strong>By email</strong>sales@ZOLARA LOGISTICS LLCconsulting.com</li>
        <li>By mail: 701 S. Coast Hwy 101, Encinitas, CA 92024</li>
      </ul>

      <h6 className="mt-5">SCHEDULE A</h6>
      <h6 className="">Accessorials</h6>
      <p className="pt-5">Lumper charges will apply based on the actual charges incurred from the Carrier.</p>
      <p className="">Layover is charged at $250 per day.</p>
      <p className="">Driver assist rates are as follows: $150 for any labor, including but not limited to moving pallets and loading or unloading services.</p>
      <p className="">Detention is charged at $60 per hour after 2 hours of waiting time at any loading or unloading facilities and charges will be rounded up to the nearest per minute increment.</p>
      <p className="">Truck order not used (TONU) is charged at $250 if the load is not canceled at least 24 hours prior to pickup.</p>
      <p className="">Out of Route Miles charge of $1.50 per mile applies when the actual mileage exceeds the planned mileage.</p>
      <p className="">Stop-Off charges will apply based on the number of additional stops. An additional stop is defined as a pickup or delivery point not including the original origin and final destination. The schedule is as follows: $75 (1st), $100 (2nd), $125 (3+).</p>
      <p className="">Any other accessorial or similar charges, including but not limited to TWIC escort fees, scale ticket costs, toll charges, late fees, trailer wash fees, pinwheeling costs, permit costs, etc. that are incurred by the Carrier on the Customer’s shipment will be charged to and paid by Customer.</p>
