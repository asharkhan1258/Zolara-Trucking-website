...
export default function BlogDetails() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={3} breadcrumbTitle="Blog Details">
                        ...
                        <div className="row g-5">
                            <div className="col-12 col-lg-8">
                                ...
                                <div className="nextprevius-text d-flex align-items-center justify-content-between mb-xxl-6 mb-xl-5 mb-4">
                                    <Link href="/blog-details" className="d-flex align-items-center gap-3" data-aos="zoom-in-left" data-aos-duration={1500}>
                                        <i className="fas fa-arrow-left" />
                                        <span className="dd-clr">
                                            Previous blog
                                        </span>
                                    </Link>
                                    <Link href="/blog-details" className="dd-clr" data-aos="zoom-in-left" data-aos-duration={1500}>
                                        Next blog
                                    </Link>
                                </div>
                                    ...
                                    <div className="col-lg-6" data-aos="zoom-in" data-aos-duration={1400}>
                                        <div className="recent-items bg1-clr d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2 py-xxl-6 py-xl-4 py-3 px-xxl-7 px-xl-5 px-lg-4 px-3">
                                            ...
                                            <div className="recent-content">
                                                ...
                                                <Link href="/news-details" className="htheme">
