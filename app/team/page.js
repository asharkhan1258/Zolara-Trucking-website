...
export default function Team() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={3} breadcrumbTitle="Our Team">
                <section className="team-section pt-space pb-space">
                    <div className="container">
                        <div className="row g-xxl-7 g-xl-5 g-lg-4 g-3">
                            ...
                            <Tilt options={toltOptions} className="col-xl-3 col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in-left" data-aos-duration={1900}>
                                <div className="team-common-item tilt">
                                    <div className="thumb position-relative overflow-hidden w-100">
                                        <img src="/assets/img/team/team5.jpg" alt="img" className="overflow-hidden w-100" />
                                        <div className="namebox py-xxl-5 py-xl-4 py-sm-3 py-2 px-3 text-center">
                                            <span className="text-capitalize white-clr d-block mb-2">
                                                Project Manager
                                            </span>
                            ...
                            <Tilt options={toltOptions} className="col-xl-3 col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in-left" data-aos-duration={2000}>
                                <div className="team-common-item tilt">
                                    <div className="thumb position-relative overflow-hidden w-100">
                                        <img src="/assets/img/team/team6.png" alt="img" className="overflow-hidden w-100" />
                                        <div className="namebox py-xxl-5 py-xl-4 py-sm-3 py-2 px-3 text-center">
                                            <span className="text-capitalize white-clr d-block mb-2">
                                                President of Sales
                                            </span>
                            ...
                            <Tilt options={toltOptions} className="col-xl-3 col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in-left" data-aos-duration={2100}>
                                <div className="team-common-item tilt">
                                    <div className="thumb position-relative overflow-hidden w-100">
                                        <img src="/assets/img/team/team7.png" alt="img" className="overflow-hidden w-100" />
                                        <div className="namebox py-xxl-5 py-xl-4 py-sm-3 py-2 px-3 text-center">
                                            <span className="text-capitalize white-clr d-block mb-2">
                                                Team Leader
                                            </span>
                            ...
                            <Tilt options={toltOptions} className="col-xl-3 col-lg-4 col-md-6 col-sm-6" data-aos="zoom-in-left" data-aos-duration={2200}>
                                <div className="team-common-item tilt">
                                    <div className="thumb position-relative overflow-hidden w-100">
                                        <img src="/assets/img/team/team8.png" alt="img" className="overflow-hidden w-100" />
                                        <div className="namebox py-xxl-5 py-xl-4 py-sm-3 py-2 px-3 text-center">
                                            <span className="text-capitalize white-clr d-block mb-2">
                                                Software Tester
                                            </span>
