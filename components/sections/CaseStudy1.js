                            ...
                            <div className="blog-widget-item bb-border pb-xxl-7 pb-xl-6 pb-4">
                                ...
                                <div className="blog-cont">
                                    <div className="d-flex align-items-center gap-xxl-5 gap-xl-4 gap-3 mb-xxl-5 mb-xl-4 mb-3">
                                        <Link href="/services" className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3 theme-clr style-2">
                                            Creative
                                    ...
                                    <h5>
                                        <Link href="/services" className="white-clr d-flex align-items-center justify-content-between gap-3">
                                        Claims Management
