        ...
        <>
            {style === 1 &&
                ...
                <a onClick={() => setOpen(true)} className="video-popup">
                    ...
                    <img src="/assets/img/element/watch-ciricle01 (1).png" alt="img" className="hero-circle "  />
                </a>
            }
            {style === 2 &&
                <a onClick={() => setOpen(true)} className="video-popup step-textcircle">
                    ...
                    <img src="/assets/img/element/watch-ciricle01 (1).png " alt="img" className="step-circle" />
                </a>
            }
            {style === 3 &&
                ...
                <img src="/assets/img/element/watch-ciricle01 (1).png" alt="img" className="circle" />
            </a>
            }
